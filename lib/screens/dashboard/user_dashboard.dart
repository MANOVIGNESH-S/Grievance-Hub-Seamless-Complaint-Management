...
class UserDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Use udweb.jpg for both web and mobile platforms
    final String backgroundImage = 'assets/images/udweb.jpg';
...
class ComplaintCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      color: Colors.white.withOpacity(0.9), // Semi-transparent background for visibility
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text('Date: ${DateFormat('dd MMM yyyy').format(complaint.timestamp)}'),
          ],
        ),
